(function (factory) {
    ...
    zip = { male: { will: '3m,&,ard,is,3ms',
            ...
            q: 'u2t@,u@ton',
            x: 'av&r' },
        female: { mari: 'a,e,lyn,0,0!,_,ssa,b;,sa,sol,tza',
    ...
    return (function () {
        ...
        var ambi = zip.ambiguous.map(replN).reduce(function (h, s) { h[s] = 'a'; return h; }, o);
        zip.ambiguous = ambi;
        return o;
    })();
});
//# sourceMappingURL=firstnames.min.js.map