(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../../nlp/_", "../index", "../../../nlp/schema", "../../../nlp/parents"], factory);
    }
})(function (require, exports) {
    "use strict";
    const _ = require("../../../nlp/_");
    const data = require("../index");
    const schema = require("../../../nlp/schema");
    const parents = require("../../../nlp/parents");
    var main = {};
    var zip = { EX: ['there'],
        NN: ['president',
            'dollar',
    ...
    var unzip = function lexicon(cat) {
        ...
        var lexiZip = {
            ...
            JJ: data.adjectivesDemonym.concat(Object.keys(data.adjectivesDecline.adverb.no), Object.keys(data.adjectivesDecline.adverb.to), Object.keys(data.adjectivesDecline.comparative.to), Object.keys(data.adjectivesDecline.superlative.to), Object.keys(data.adverbsDecline).map(function (s) { return data.adverbsDecline[s]; })),
            CD: nrOnes.concat(Object.keys(data.numbers.teens), Object.keys(data.numbers.tens), Object.keys(data.numbers.multiple), Object.keys(data.dates.months), Object.keys(data.dates.days))
        };
        if (cat === 1) {
            return [did, lexiZip];
        }
        if (!cat) {
            var toMain = function (key, o) {
                o[key].forEach(function (w) { if (w && !main[w]) {
                    main[w] = key;
                } });
            };
            for (var key in did) {
