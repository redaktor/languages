...
import { Constructor, InjectorFactory, InjectorItem, RegistryLabel, WidgetBaseConstructor, WidgetBaseInterface, ESMDefaultWidgetBase, WidgetBaseConstructorFunction, ESMDefaultWidgetBaseFunction, Callback, WNodeFactory, RenderResult, WidgetBaseTypes } from './interfaces';
export declare type RegistryItem = WidgetBaseConstructor | WNodeFactory<any> | Promise<WidgetBaseConstructor | WNodeFactory<any>> | WidgetBaseConstructorFunction | ESMDefaultWidgetBaseFunction;
/**
 * Widget base type
 */
export declare const WIDGET_BASE_TYPE = "__widget_base_type";
 ...
 */
export declare function isWidgetBaseConstructor<T extends WidgetBaseInterface = any>(item: any): item is Constructor<T>;
export declare function isWidgetFunction(item: any): item is Callback<any, any, RenderResult>;
export declare function isWNodeFactory<W extends WidgetBaseTypes>(node: any): node is WNodeFactory<W>;
export declare function isWidget<T extends WidgetBaseInterface = any>(item: any): item is Constructor<T> | Callback<any, any, RenderResult>;
export declare function isWidgetConstructorDefaultExport<T extends WidgetBaseTypes>(item: any): item is ESMDefaultWidgetBase<T>;
/**
