(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../shim/Map", "../shim/WeakMap", "./diff", "./RegistryHandler", "./NodeHandler", "./Registry", "./vdom"], factory);
    }
    ...
    var decoratorMap = new WeakMap_1.default();
    var builtDecoratorMap = new WeakMap_1.default();
    var boundAuto = diff_1.auto.bind(null);
    function isDomMeta(meta) {
        return Boolean(meta.afterRender);
    }
    var IGNORE_LIST = tslib_1.__spread(['render'], Object.getOwnPropertyNames(Object.getPrototypeOf({})));
    var autoBindCache = new Map_1.default();
    function autoBind(instance) {
        ...
        if (autoBindCache.has(prototype)) {
            ...
            var _loop_1 = function () {
                var ownKeys = Object.getOwnPropertyNames(prototype);
                ...
                var getterKeys = descriptorKeys.filter(function (key) { return descriptors[key].get || descriptors[key].set; });
                var filteredKeys = ownKeys.filter(function (key) { return getterKeys.indexOf(key) === -1; });
                keys = tslib_1.__spread(keys, filteredKeys);
            ...
            keys = keys.filter(function (k) { return typeof instance[k] === 'function' && IGNORE_LIST.indexOf(k) === -1; });
            autoBindCache.set(prototype, keys);
        }
        var _loop_2 = function (i) {
            var key = keys[i];
            var boundFunc = instance[key].bind(instance);
    ...
    var WidgetBase = /** @class */ (function () {
        ...
        function WidgetBase() {
            ...
            this.own({
                destroy: function () {
                    vdom_1.widgetInstanceMap.delete(_this);
                    _this._nodeHandler.clear();
                    _this._nodeHandler.destroy();
                }
            });
        ...
        WidgetBase.prototype.__setProperties__ = function (originalProperties) {
            ...
            if (this._initialProperties === false || registeredDiffPropertyNames.length !== 0) {
                ...
                for (var i = 0; i < allProperties.length; i++) {
                    ...
                    var newProperty = properties[propertyName];
        ...
        WidgetBase.prototype.__render__ = function () {
            ...
            var dNode = this._runAfterRenders(render());
            return dNode;
        };
        ...
        WidgetBase.prototype.render = function () {
            return vdom_1.v('div', {}, this.children);
        };
        /**
        ...
        WidgetBase.prototype._buildDecoratorList = function (decoratorKey) {
            ...
            var buildDecorators = builtDecoratorMap.get(this.constructor) || new Map_1.default();
        ...
        WidgetBase.prototype.getDecorator = function (decoratorKey) {
            var decoratorCache = builtDecoratorMap.get(this.constructor);
            var allDecorators = this._decoratorCache.get(decoratorKey) || (decoratorCache && decoratorCache.get(decoratorKey));
            if (allDecorators !== undefined) {
                return allDecorators;
            }
            allDecorators = this._buildDecoratorList(decoratorKey);
            allDecorators = tslib_1.__spread(allDecorators);
