(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../../shim/WeakMap", "../../shim/Map", "./Base", "../../shim/IntersectionObserver"], factory);
    }
    ...
    var Intersection = /** @class */ (function (_super) {
        ...
        Intersection.prototype._createDetails = function (options, rootNode) {
            ...
            var observer = new IntersectionObserver_1.default(this._onIntersect(entries), tslib_1.__assign({}, options, { root: rootNode }));
            var details = tslib_1.__assign({ observer: observer, entries: entries }, options);
            this._details.set(JSON.stringify(options), details);
            this.own({
                destroy: function () { return observer.disconnect(); }
            });
            return details;
        };
