import { DOMRectReadOnly } from '../../shim/ResizeObserver';
export declare const resize: import("../interfaces").MiddlewareResultFactory<import("../interfaces").WidgetProperties, {
