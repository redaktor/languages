(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../../i18n/i18n", "../../shim/Map", "./../vdom", "./../decorators/afterRender", "./../decorators/inject", "./../Injector", "../util"], factory);
    }
            ...
            I18n = tslib_1.__decorate([
                inject_1.inject({
                    ...
                    getProperties: function (localeData, properties) {
                        var _a = properties.locale, locale = _a === void 0 ? localeData.get().locale : _a, _b = properties.rtl, rtl = _b === void 0 ? localeData.get().rtl : _b;
