(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../WidgetBase", "./../vdom", "../decorators/alwaysRender"], factory);
    }
    ...
    function ProjectorMixin(Base) {
        var Projector = /** @class */ (function () {
            ...
            Projector.prototype.append = function (root) {
                ...
                this._root = root;
                this._renderResult = vdom_1.w(ProjectorWidget, {
                    renderer: function () {
                        var _a = _this._properties, registry = _a.registry, props = tslib_1.__rest(_a, ["registry"]);
                        return vdom_1.w(_this._widget, props, _this._children);
                    }
                });
