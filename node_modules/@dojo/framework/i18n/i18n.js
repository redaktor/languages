(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../shim/global", "../shim/iterator", "../shim/Map", "../core/Evented", "../core/has", "../core/util", "globalize/dist/globalize/message", "./cldr/load", "./util/main"], factory);
    }
    ...
    function loadLocaleBundles(locales, supported) {
        return Promise.all(supported.map(function (locale) { return locales[locale](); })).then(function (bundles) {
            return bundles.map(function (bundle) { return useDefault(bundle); });
        });
    }
    /**
     * @private
