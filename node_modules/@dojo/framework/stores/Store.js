(function (factory) {
    ...
    var DefaultState = /** @class */ (function () {
        function DefaultState() {
             ...
             */
            this.apply = function (operations) {
    ...
    var Store = /** @class */ (function (_super) {
        ...
        function Store(options) {
            ...
            _this._adapter = new DefaultState();
            ...
            _this.get = function (path) {
                return _this._adapter.get(path);
            };
            /**
             * Applies store operations to state and returns the undo operations
             */
            _this.apply = function (operations, invalidate) {
                ...
                var result = _this._adapter.apply(operations);
                if (invalidate) {
                    _this.invalidate();
                }
                return result;
            ...
            _this.at = function (path, index) {
                return _this._adapter.at(path, index);
            };
            ...
            _this.path = _this._adapter.path.bind(_this._adapter);
            if (options && options.state) {
                _this._adapter = options.state;
                _this.path = _this._adapter.path.bind(_this._adapter);
            }
            return _this;
        }
        Store.prototype._runOnChanges = function () {
            ...
            this._changePaths.forEach(function (value, path) {
                ...
                var pointer = new Pointer_1.Pointer(path);
                var newValue = pointer.segments.length
                    ? (_a = _this._adapter).path.apply(_a, tslib_1.__spread([pointer.segments[0]], pointer.segments.slice(1))).value
                    : undefined;
