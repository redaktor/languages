(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../shim/WeakMap", "../core/WidgetBase", "../core/decorators/handleDecorator", "../core/decorators/beforeProperties", "../core/decorators/alwaysRender", "../core/Registry", "../core/vdom"], factory);
    }
    ...
    var handleDecorator_1 = require("../core/decorators/handleDecorator");
    var beforeProperties_1 = require("../core/decorators/beforeProperties");
    var alwaysRender_1 = require("../core/decorators/alwaysRender");
            ...
            beforeProperties_1.beforeProperties(function (properties) {
                ...
                if (injectorItem) {
                    ...
                    if (registeredInjectors.indexOf(injectorItem) === -1) {
                        if (paths) {
                            var invalidatePaths = void 0;
                            if (typeof paths === 'function') {
                                invalidatePaths = paths(store_1.path);
                            }
                            else {
                                invalidatePaths = paths.map(function (path) { return store_1.path(path.join('/')); });
                            }
                            var handle_1 = store_1.onChange(invalidatePaths, function () { return _this.invalidate(); });
                            this.own({
                                destroy: function () {
                                    handle_1.remove();
                                }
    ...
    function StoreContainer(component, name, _a) {
        ...
        var WidgetContainer = /** @class */ (function (_super) {
            ...
            WidgetContainer.prototype.render = function () {
                return vdom_1.w(component, this.properties, this.children);
            };
