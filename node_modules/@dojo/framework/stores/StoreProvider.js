(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "../core/WidgetBase", "../core/decorators/diffProperty", "../core/diff", "../core/decorators/alwaysRender"], factory);
    }
    ...
    var diffProperty_1 = require("../core/decorators/diffProperty");
    ...
    var StoreProvider = /** @class */ (function (_super) {
        ...
        StoreProvider.prototype._getProperties = function () {
            return tslib_1.__assign({ stateKey: 'state' }, this.properties);
        };
        StoreProvider.prototype.onChange = function (previousProperties, currentProperties) {
            var _this = this;
            var _a = currentProperties.stateKey, stateKey = _a === void 0 ? 'state' : _a, paths = currentProperties.paths;
            if (this._handle) {
        ...
        StoreProvider.prototype.render = function () {
            var _a = this._getProperties(), stateKey = _a.stateKey, renderer = _a.renderer;
            var store = this._getStore(stateKey);
            if (!this._handle) {
