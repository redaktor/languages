(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "tslib", "css-select-umd", "../../core/vdom", "../../core/util"], factory);
    }
    ...
    exports.adapter = {
        ...
        getChildren: function (elem) {
            return vdom_1.isVNode(elem) || vdom_1.isWNode(elem) ? elem.children : [];
        },
        getAttributeValue: function (elem, name) {
            if (vdom_1.isVNode(elem) || vdom_1.isWNode(elem)) {
                if (name === 'class') {
